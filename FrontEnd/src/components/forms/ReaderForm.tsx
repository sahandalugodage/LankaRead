    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      <div>
        ...
        <input
          ...
          className={`w-full px-3.5 py-2.5 bg-slate-950 border ${
            errors.name ? "border-red-500" : "border-slate-800 focus:border-teal-500"
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div>
          ...
          <input
            ...
            onChange={handleChange}
            className={`w-full px-3.5 py-2.5 bg-slate-950 border ${
              errors.email ? "border-red-500" : "border-slate-800 focus:border-teal-500"
            } text-slate-100 placeholder-slate-500 rounded-xl text-sm focus:outline-none transition`}
            placeholder="e.g. nimal.perera@lankaread.lk"
          />
        ...
        <div>
          ...
          <input
            ...
            onChange={handleChange}
            className={`w-full px-3.5 py-2.5 bg-slate-950 border ${
              errors.phoneNumber ? "border-red-500" : "border-slate-800 focus:border-teal-500"
            } text-slate-100 placeholder-slate-500 rounded-xl text-sm focus:outline-none transition`}
      ...
      <div>
        ...
        <textarea
          ...
          rows={2}
          className={`w-full px-3.5 py-2.5 bg-slate-950 border ${
            errors.address ? "border-red-500" : "border-slate-800 focus:border-teal-500"
          } text-slate-100 placeholder-slate-500 rounded-xl text-sm focus:outline-none transition`}
      ...
      <div>
        ...
        <input
          ...
          onChange={handleChange}
          className={`w-full px-3.5 py-2.5 bg-slate-950 border ${
            errors.registerDate ? "border-red-500" : "border-slate-800 focus:border-teal-500"
