    ...
    <div className="p-4 sm:p-6 lg:p-8 max-w-7xl mx-auto space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-slate-900/80 p-6 rounded-2xl border border-slate-800 backdrop-blur-md shadow-xl">
        <div>
          ...
          <h1 className="text-2xl font-extrabold text-white tracking-tight">Overdue Loan Notices</h1>
          <p className="text-xs text-slate-400 mt-1">Send automated return notices to members with past-due items</p>
        </div>

        <div className="flex items-center space-x-3">
          <div className="px-4 py-2 bg-rose-500/10 border border-rose-500/20 rounded-xl text-rose-400 text-xs font-bold">
