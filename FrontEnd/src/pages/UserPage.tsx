    ...
    <div className="p-4 sm:p-6 lg:p-8 max-w-7xl mx-auto space-y-8">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-slate-900/80 p-6 rounded-2xl border border-slate-800 backdrop-blur-md shadow-xl">
        <div>
          ...
          <h1 className="text-2xl font-extrabold text-white tracking-tight">System Staff & Administrators</h1>
        ...
        <button
          ...
          title="Refresh Users"
        >
          <MdSync className={`w-5 h-5 ${loading ? "animate-spin text-teal-400" : ""}`} />
        </button>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2">
          <h2 className="text-lg font-bold text-white mb-4">Registered Staff Members</h2>
