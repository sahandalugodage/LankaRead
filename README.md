# LankaRead | Library & Knowledge Portal

A full-stack, real-time Library & Knowledge Portal designed for public and academic library networks in Sri Lanka (Colombo, Kandy, Galle, and Peradeniya branches). Built using React (TypeScript), Node.js (Express), MongoDB, and WebSockets (Socket.IO).

## Core Capabilities

- **Reader & Member Directory**: Register members, track contact details, and manage membership status.
- **Book Catalog Management**: Comprehensive catalog with stock tracking, genre categorization, and quick search.
