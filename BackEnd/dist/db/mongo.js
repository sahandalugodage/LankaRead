...
const connectDB = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const mongoUri = process.env.MONGO_URI || "mongodb://127.0.0.1:27017/lankaread_db";
...
const seedInitialData = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const adminEmail = "admin@lankaread.lk";
        ...
        if (readerCount === 0) {
            yield Reader_1.ReaderModel.insertMany([
                {
                    name: "Kasun Perera",
                    email: "kasun.perera@lankaread.lk",
                ...
                },
                {
                    ...
                    email: "pathum.nissanka@lankaread.lk",
                ...
                },
                {
                    ...
                    email: "tharushi.fernando@lankaread.lk",
